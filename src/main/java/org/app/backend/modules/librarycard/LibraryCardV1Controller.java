...
public class LibraryCardV1Controller {
        ...
        responses = {
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
                ...
                content = @Content(
                    ...
                    schema = @Schema(
                        implementation = PagedApiResponseLibraryCardDTO.class
                    )
                )
            ),
        }
    ...
    public PagedApiResponse<LibraryCardDTO> index(
        ...
        return PagedApiResponse.success(
            libraryCardService.findAll(pageable, userId, status),
        ...
        responses = {
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
                ...
                content = @Content(
                    mediaType = "application/json",
                    schema = @Schema(
                        implementation = DataApiResponseLibraryCardDTO.class
                    )
                )
            ),
        }
    ...
    public DataApiResponse<LibraryCardDTO> show(@PathVariable UUID id) {
        return DataApiResponse.success(
            libraryCardService.findById(id),
            "Lấy chi tiết thẻ thành công"
        );
    }
    ...
    public DataApiResponse<LibraryCardDTO> lock(
        ...
        return DataApiResponse.success(
            libraryCardService.lock(id, actor),
            "Khóa thẻ thành công"
        );
    }
    ...
    public DataApiResponse<LibraryCardDTO> replace(
        ...
        return DataApiResponse.success(
            libraryCardService.replace(id, actor),
            "Làm lại thẻ thành công"
        );
    }
    ...
    @Operation(
        ...
        requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(
            ...
            content = @Content(
                mediaType = MediaType.APPLICATION_JSON_VALUE,
                schema = @Schema(
                    implementation = LibraryCardRequestCreateDTO.class
                )
            )
        ),
        responses = {
    ...
    public static class PagedApiResponseLibraryCardDTO
        extends PagedApiResponse<LibraryCardDTO> {}

    public static class DataApiResponseLibraryCardDTO
        extends DataApiResponse<LibraryCardDTO> {}
}
