...
public class SubscriptionCreateDTO {
    ...
    @Pattern(
        regexp = "^[A-Z0-9_]+$",
        message = "Mã gói chỉ được chứa chữ hoa, số và dấu gạch dưới"
    )
    String key;
    ...
    @Max(
        value = 1000,
        message = "Giới hạn mượn tối đa không được vượt quá 1000 quyển"
    )
    Integer maxBooks;
    ...
    @Max(
        value = 100000000,
        message = "Phí không được vượt quá 100,000,000 đồng"
    )
    Integer price;
    ...
    @Max(
        value = 1000000,
        message = "Phí trễ hạn không được vượt quá 1,000,000 đồng/ngày"
    )
