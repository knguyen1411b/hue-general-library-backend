...
public class SubscriptionV1Controller {
        ...
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            ...
            content =
                @Content(
                    ...
                    schema = @Schema(implementation = PagedApiResponseSubscriptionDTO.class))),
      })
  @BadRequestApiResponse
  @ForbiddenApiResponse
  @GetMapping
  public PagedApiResponse<SubscriptionDTO> index(@ParameterObject Pageable pageable) {
    return PagedApiResponse.success(
        subscriptionService.findAll(pageable), SubscriptionMessage.INDEX_SUCCESS.getMessage());
  }
      ...
      responses = {
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            ...
            content =
                @Content(
                    mediaType = "application/json",
                    schema = @Schema(implementation = DataApiResponseSubscriptionDTO.class))),
      })
  @NotFoundApiResponse
  @ForbiddenApiResponse
  @GetMapping("/{id}")
  public DataApiResponse<SubscriptionDTO> show(@PathVariable UUID id) {
    return DataApiResponse.success(
        subscriptionService.findById(id), SubscriptionMessage.SHOW_SUCCESS.getMessage());
  }
  ...
  @ForbiddenApiResponse
  @GetMapping("/key/{key}")
  public DataApiResponse<SubscriptionDTO> findByKey(@PathVariable String key) {
    return DataApiResponse.success(
        subscriptionService.findByKey(key), SubscriptionMessage.SHOW_SUCCESS.getMessage());
  }
  ...
  public ApiResponse create(
    ...
    return ApiResponse.created(SubscriptionMessage.CREATE_SUCCESS.getMessage());
  }
  ...
  public ApiResponse update(
    ...
    return ApiResponse.success(SubscriptionMessage.UPDATE_SUCCESS.getMessage());
  }
  ...
  public ApiResponse delete(
    ...
    return ApiResponse.success(SubscriptionMessage.DELETE_SUCCESS.getMessage());
  }

  public static class PagedApiResponseSubscriptionDTO extends PagedApiResponse<SubscriptionDTO> {}

  public static class DataApiResponseSubscriptionDTO extends DataApiResponse<SubscriptionDTO> {}
}
