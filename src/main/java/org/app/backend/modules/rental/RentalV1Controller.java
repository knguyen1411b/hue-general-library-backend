...
public class RentalV1Controller {
        ...
        responses = {
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
                ...
                content = @Content(
                    ...
                    schema = @Schema(
                        implementation = PagedApiResponseRentalDTO.class
                    )
                )
            ),
        }
        ...
        responses = {
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
                ...
                content = @Content(
                    mediaType = "application/json",
                    schema = @Schema(
                        implementation = DataApiResponseRentalDTO.class
                    )
                )
            ),
        }
    ...
    public DataApiResponse<RentalDTO> returnBook(
        ...
        return DataApiResponse.success(
            rentalService.returnBook(id, actor),
    ...
    public DataApiResponse<RentalDTO> renewBook(
        ...
        return DataApiResponse.success(
            rentalService.renewBook(id, actor),
    ...
    public DataApiResponse<RentalDTO> reportLost(
        ...
        return DataApiResponse.success(
            rentalService.reportLost(id, actor),
    ...
    public static class PagedApiResponseRentalDTO
        extends PagedApiResponse<RentalDTO> {}

    public static class DataApiResponseRentalDTO
        extends DataApiResponse<RentalDTO> {}
}
