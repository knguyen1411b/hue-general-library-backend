...
public class FineV1Controller {
        ...
        responses = {
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
                ...
                content = @Content(
                    ...
                    schema = @Schema(
                        implementation = PagedApiResponseFineDTO.class
                    )
                )
            ),
        }
    ...
    public PagedApiResponse<FineDTO> index(
        ...
        return PagedApiResponse.success(
            fineService.findAll(pageable, rentalId, status),
            "Lấy danh sách phiếu phạt thành công"
        );
    }
        ...
        responses = {
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
                ...
                content = @Content(
                    mediaType = "application/json",
                    schema = @Schema(
                        implementation = DataApiResponseFineDTO.class
                    )
                )
            ),
        }
    ...
    public ApiResponse create(
        @Valid @RequestBody FineCreateDTO dto,
    ...
    public static class PagedApiResponseFineDTO
        extends PagedApiResponse<FineDTO> {}

    public static class DataApiResponseFineDTO
        extends DataApiResponse<FineDTO> {}
}
