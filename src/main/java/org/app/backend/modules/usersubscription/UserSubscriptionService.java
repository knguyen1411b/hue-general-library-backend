...
public interface UserSubscriptionService {
  ...
  UserSubscription renewSubscription(UUID userSubscriptionId, LocalDate newStartDate, LocalDate newEndDate);
  ...
  // New method for statistics API
  Object getStatistics(UUID userId);
}
