...
class AuthServiceImplTest {
  ...
  void testSignIn_Success() {
    ...
    when(passwordEncoder.matches(signInDTO.getPassword(), mockUser.getPasswordHash()))
        .thenReturn(true);
  ...
  void testSignUp_Success() {
    // Arrange
    org.app.backend.modules.auth.dto.SignUpDTO signUpDTO =
        new org.app.backend.modules.auth.dto.SignUpDTO();
    ...
    verify(userRepository, times(1))
        .save(mappedUser); // Called again after file uploads (even if null)
  ...
  void testSignUp_UsernameTaken() {
    ...
    assertEquals(
        org.app.backend.modules.user.UserMessage.USERNAME_TAKEN.getMessage(),
