...
class LibraryCardRequestServiceImplTest {
  ...
  void testGetRequestById_Success() {
    when(requestRepository.findWithUserById(any())).thenReturn(Optional.of(mockRequest));

    LibraryCardRequestDTO result =
        libraryCardRequestService.getRequestById(java.util.UUID.randomUUID());
